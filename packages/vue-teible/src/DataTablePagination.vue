	...
	<nav class="datatable__pagination">
		<ul class="datatable__plist">
			<li class="datatable__pitem">
				<a :class="[ 'datatable__plink datatable__pprev', { 'datatable__plink--disabled': reachedFirst }]" href="#" aria-label="Previous" @click.prevent="load(page-1)">
					<span aria-hidden="true">&laquo;</span>
				</a>
			</li>
			<li v-for="(page, index) in pages" :key="index" class="datatable__pitem">
